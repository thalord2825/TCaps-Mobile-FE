...
export function AdminHomeContent() {
  ...
  return (
    <>
      {/* Modal for product management -- appears when button pressed */}
      <ProductManagementModal visible={showProductModal} onClose={() => setShowProductModal(false)} />
